// constructor that displays an underlying character or a blank placeholder based on if the user has or has not guessed the letter
// string value that stores the underlying character ofr the letter
